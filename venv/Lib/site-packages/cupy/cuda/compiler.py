...
def _jitify_prep(source, options, cu_path):
    print('cu_path', cu_path)
    #print(source)
    #print(options)
    from cupy.cuda import jitify
    print('jitify loc',jitify.__file__)
    ...
    global _jitify_header_source_map_populated
    print("Before checking _jitify_header_source_map_populated")
    if not _jitify_header_source_map_populated:
        print("Before importing core module")
        from cupy._core import core
        print("Before jitify._init_module()")
        jitify._init_module()
        print("Before jitify._add_sources()")
        jitify._add_sources(core._get_header_source_map())
        _jitify_header_source_map_populated = True
