...
def load_ephem(dtime: dattetime,dtime2: datetime):
...
def get_polygons(polygon_fp : str,start: datetime, end: datetime):
...
def find_emptymask(time_view_start: datetime, time_view_end: datetime, val: str,
                    file_data: str, polygon_fp: str, ind: int, fp_sav:str):
