...
test_lfe = test_unselected.loc[test_unselected['label']!='NoLFE', 'id']
test_nolfe = test_unselected.loc[test_unselected['label']=='NoLFE', 'id']
train_lfe = train_unselected.loc[train_unselected['label']!='NoLFE', 'id']
